...
/** Soft claymation-style floating island for the first-run empty state. */
export function FloatingIslandIllustration({
  className,
}: {
  className?: string;
}) {
  return (
    ...
    >
      <defs>
        <linearGradient id="fi-grass" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#9ee493" />
          <stop offset="100%" stopColor="#5bbf6a" />
        </linearGradient>
        <linearGradient id="fi-soil" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#8b6a4f" />
          <stop offset="100%" stopColor="#5d4433" />
        </linearGradient>
        <linearGradient id="fi-roof" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#f08a6a" />
          <stop offset="100%" stopColor="#d9613f" />
        </linearGradient>
      </defs>

      {/* clouds */}
      <g opacity="0.95">
        <ellipse cx="62" cy="46" rx="30" ry="17" fill="#fbd5e8" />
        <ellipse cx="84" cy="40" rx="20" ry="13" fill="#fce7f3" />
        <ellipse cx="236" cy="60" rx="30" ry="17" fill="#d7e9fb" />
        <ellipse cx="214" cy="53" rx="19" ry="12" fill="#e8f3fd" />
        <ellipse cx="52" cy="176" rx="34" ry="19" fill="#ded5f7" />
        <ellipse cx="80" cy="182" rx="22" ry="13" fill="#ece6fb" />
        <ellipse cx="246" cy="158" rx="32" ry="18" fill="#cfe8fb" />
        <ellipse cx="222" cy="164" rx="20" ry="12" fill="#e3f2fd" />
      </g>

      {/* island */}
      <path
        d="M150 92c46 0 84 12 84 27s-38 27-84 27-84-12-84-27 38-27 84-27Z"
        fill="url(#fi-grass)"
      />
      <path
        d="M66 119c0 15 38 27 84 27s84-12 84-27c0 0 4 28-10 46-11 14-30 30-48 42-10 7-19 7-29 0-19-12-40-28-51-42-14-18-30-46-30-46Z"
        fill="url(#fi-soil)"
      />
      <path
        d="M150 92c46 0 84 12 84 27 0 6-6 11-16 15-16-8-41-13-68-13s-52 5-68 13c-10-4-16-9-16-15 0-15 38-27 84-27Z"
        fill="#b6ec9f"
        opacity="0.55"
      />
      ...
      {/* path */}
      <path
        d="M136 141c-6-8-2-16 8-19 12-4 20-9 18-16"
        stroke="#c9a882"
        strokeWidth="9"
        strokeLinecap="round"
      />
      ...
      {/* house */}
      <path d="M150 66l30 20v34h-60V86l30-20Z" fill="#fdf3e6" />
      <path
        d="M150 60l38 27h-76l38-27Z"
        fill="url(#fi-roof)"
        strokeLinejoin="round"
      />
      <rect x="140" y="100" width="20" height="20" rx="3" fill="#8b6a4f" />
      <rect x="124" y="92" width="11" height="11" rx="2.5" fill="#ffd98a" />
      <rect x="165" y="92" width="11" height="11" rx="2.5" fill="#ffd98a" />

      {/* trees */}
      <g>
        <rect x="105" y="106" width="6" height="14" rx="3" fill="#8b6a4f" />
        <circle cx="108" cy="99" r="14" fill="#68c96f" />
        <circle cx="101" cy="103" r="9" fill="#8bd98d" />
      </g>
      <g>
        <rect x="192" y="108" width="6" height="13" rx="3" fill="#8b6a4f" />
        <circle cx="195" cy="102" r="12" fill="#5bbf6a" />
        <circle cx="201" cy="106" r="8" fill="#7fd487" />
      </g>

      {/* sparkles */}
      <circle cx="40" cy="108" r="4" fill="#f9a8d4" />
      <circle cx="264" cy="112" r="3.5" fill="#a5d8f8" />
      <circle cx="60" cy="220" r="3" fill="#ddccfc" />
    </svg>
  );
}
